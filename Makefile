...
#---------------------------------------------------------------------------------
TITLE		:=	Rock Paper Scissors - FrontendTitan
APPID		:=	FTRPS
CONTENTID	:=	UP0002-$(APPID)_00-1234500000000000
ICON0 		:=  ICON0.png
...
LDFLAGS    +=   -L$(PS3SDK)/tiny3D-master/lib/include
LIBS       +=   -Wl,--start-group -ltiny3d -Wl,--end-group
LIBS       +=   -lm
